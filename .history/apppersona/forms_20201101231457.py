...
class FormularioPersona(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'rut' : Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'nombre', 'class': 'form-control', 'required onfocus': "setVisibility('100','inline')", 'onBlur': "setVisibility('104','none')", })
          }
