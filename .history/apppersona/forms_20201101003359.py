...
class ExtendedUserCreationForm(UserCreationForm):
    username = forms.CharField(forms.TextInput(attrs={'class': 'form-control'}))
    first_name = forms.CharField(forms.TextInput(attrs={'class': 'form-control'}))
    last_name = forms.CharField(forms.TextInput(attrs={'class': 'form-control'}))
    email=forms.EmailField(forms.EmailInput(attrs={'class':'form-control'}))
    password1=forms.CharField(forms.PasswordInput(attrs={'class': 'form-control'}))
    password2=forms.CharField(forms.PasswordInput(attrs={'class': 'form-control'}))
    class meta:
        model = User
