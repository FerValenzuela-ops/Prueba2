...
class FormularioPersona(forms.ModelForm) :
    ...
    class Meta:
        ...
        widgets = {
          ...
          'email': EmailField(attrs={'rows':1, 'cols':30, 'style':'resize:none;', 'id': 'email', 'class':"form-control", 'required onfocus':"setVisibility('102','inline')", 'onBlur':"setVisibility('102','none')"}),
