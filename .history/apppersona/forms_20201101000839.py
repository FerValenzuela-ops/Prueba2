...
class ExtendedUserCreationForm(UserCreationForm):
    ...
    class meta:
        ...
        widgets = {
            'first_name': Textarea(attrs={'id': 'first_name','rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'nombre', 'class': 'form-control', 'required onfocus': "setVisibility('100','inline')", 'onBlur': "setVisibility('100','none')"}),
