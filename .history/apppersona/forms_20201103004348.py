...
class ExtendedUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].widget = PasswordInput(attrs = {'class': 'form-control', 'id':'password1', 'required onfocus': "setVisibility('104','inline')", 'onBlur': "setVisibility('104','none')"})
        self.fields['password2'].widget = PasswordInput(attrs = {'class': 'form-control', 'id':'password2','required onfocus': "setVisibility('104','inline')", 'onBlur': "setVisibility('104','none')"})
