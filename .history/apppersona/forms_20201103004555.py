...
class FormularioPersona(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'edad' : Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'rut', 'class': 'form-control', 'required onfocus': "setVisibility('106','inline')", 'onBlur': "setVisibility('106','none')", })
          }
