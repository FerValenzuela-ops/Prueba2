...
from apppersona.serializers import PersonaSerializer, UserSerializer
...
class PersonaViewSet(viewsets.ModelViewSet) : 
    """
        endpoints para acceder a las personas registradas
    """

    queryset = Persona.objects.all()
    serializer_class = PersonaSerializer
    permission_classes = [permissions.IsAuthenticated permissions.IsAuthenticated and permissions.IsAdminUser]    
