...
class ExtendedUserCreationForm(UserCreationForm):
    username = forms.TextInput(attrs={'id': 'first_name','rows': 1, 'cols': 30, 'style': 'resize:none;',  'class': 'form-control', 'required onfocus': "setVisibility('100','inline')", 'onBlur': "setVisibility('100','none')"})
