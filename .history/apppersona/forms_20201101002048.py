...
class ExtendedUserCreationForm(UserCreationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget = TextInput(attrs = {{'id': 'first_name','rows': 1, 'cols': 30, 'style': 'resize:none;',  'class': 'form-control', 'required onfocus': "setVisibility('100','inline')", 'onBlur': "setVisibility('100','none')"}})
        ...
        self.fields['email'].widget = PasswordInput(attrs = {'class': 'form-control',})
        self.fields['first_name'].widget = PasswordInput(attrs = {'class': 'form-control',})
        self.fields['last_name'].widget = PasswordInput(attrs = {'class': 'form-control',})
