...
class FormularioPersona(forms.ModelForm) :
    ...
    class Meta:
        ...
        widgets = {
          ...
          'email': Textarea(attrs={'rows':1, 'cols':30, 'style':'resize:none;', 'id': 'email', 'class': 'email'}),
          'celular': Textarea(attrs={'rows':1, 'cols':30, 'style':'resize:none;'}),
          'usuario': Textarea(attrs={'rows':1, 'cols':30, 'style':'resize:none;'}),
          'contraseña': Textarea(attrs={'rows':1, 'cols':30, 'style':'resize:none;', 'id': 'pass', 'class': 'pass' }),
