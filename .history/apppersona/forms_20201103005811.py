...
class FormularioContacto(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'asunto': Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'asunto', 'class': "form-control", }),
            'email': EmailInput(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'email', 'class': "form-control",  'type': 'email',  }),
            'telefono': Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'telefono', 'class': "form-control", }),
            'mensaje' : Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'mensaje', 'class': 'form-control',  }),
           }        