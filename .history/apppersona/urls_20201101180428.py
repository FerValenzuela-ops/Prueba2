...
urlpatterns = [
    ...
    path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(template_name='apppersona/registration/password_reset_done.html'), name='password_reset_done'),
