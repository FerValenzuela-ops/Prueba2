...
class FormularioContacto(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'asunto': Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'asuntoContacto', 'class': "form-control", }),
            'email': EmailInput(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'emailContacto', 'class': "form-control",  'type': 'email',  }),
            'telefono': Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'telefonoContacto', 'class': "form-control", }),
            'mensaje' : Textarea(attrs={'rows': 1, 'cols': 30, 'style': 'resize:none;', 'id': 'mensajeContacto', 'class': 'form-control',  }),
           }        